    ...
    <div id="content">
      ...
      <div class="payleft">
        ...
        <div class="productshow scrollbar">
          <div class="showtea" v-for="product in $store.state.cart.added">
            <div class="showtealeft" >
              <img :src="'api'+product.pro_img1">
            </div>
            <div class="showtearight">
              <h4>{{product.pro_name}}</h4>
              <h5>单价：<span class="perprice">{{product.pro_price}}</span></h5>
              <h5>数量：<span class="number">{{product.sc_amount}}</span></h5>
            </div>
          </div>
        </div>
...
//        var order_price = $("#order_price").val();
        ...
        var order_price = parseInt($("#order_price").html());
        ...
        that.$axios.post("/api/addOrderOne.do",{order_id:order_id,order_postmethod:order_postmethod,
